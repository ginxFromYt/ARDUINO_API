        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
            ...
            <form method="POST" action="{{ route('esp32.sendCommand') }}" class="mb-6">
                ...
                <div class="flex gap-2 items-center">
                    ...
                    <button type="submit" class="bg-blue-600 dark:bg-blue-400 text-black px-4 py-2 rounded hover:bg-blue-700 dark:hover:bg-blue-300 transition-colors shadow-sm">Send</button>
                </div>
            </form>
            <div class="mt-4">
